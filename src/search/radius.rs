...
pub fn search_radius128(
    ...
    search_radius64(lsp, lsc, ltp, radius).flat_map(move |(ltc, lsod)| search_radius64(rsp, rsc, rtp, radius - lsod).map(|(rtc, rsod)| (Bits1::union(ltc, rtc), lsod + rsod)))
}
...
pub fn search_radius64(
    ...
    search_radius32(lsp, lsc, ltp, radius).flat_map(move |(ltc, lsod)| search_radius32(rsp, rsc, rtp, radius - lsod).map(|(rtc, rsod)| (Bits2::union(ltc, rtc), lsod + rsod)))
}
...
pub fn search_radius32(
    ...
    search_radius16(lsp, lsc, ltp, radius).flat_map(move |(ltc, lsod)| search_radius16(rsp, rsc, rtp, radius - lsod).map(|(rtc, rsod)| (Bits4::union(ltc, rtc), lsod + rsod)))
}
...
pub fn search_radius16(
    ...
    search_radius8(lsp, lsc, ltp, radius).flat_map(move |(ltc, lsod)| search_radius8(rsp, rsc, rtp, radius - lsod).map(|(rtc, rsod)| (Bits8::union(ltc, rtc), lsod + rsod)))
}
...
pub fn search_radius8(
    ...
    search_radius4(lsp, lsc, ltp, radius).flat_map(move |(ltc, lsod)| search_radius4(rsp, rsc, rtp, radius - lsod).map(|(rtc, rsod)| (Bits16::union(ltc, rtc), lsod + rsod)))
}
...
pub fn search_radius4(
    ...
    search_radius2(lsp, lsc, ltp, radius).flat_map(move |(ltc, lsod)| search_radius2(rsp, rsc, rtp, radius - lsod).map(|(rtc, rsod)| (Bits32::union(ltc, rtc), lsod + rsod)))
}
...
pub fn search_radius2(
    ...
    search_radius(64, sl, sw, tw, radius).map(|([tl, tr], sod)| (Bits64((tl as u128) << 64 | tr as u128), sod))
}
